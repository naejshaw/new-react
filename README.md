...
```sh {"id":"01J4Q66FSHQT9E1XA2YE2FZ1Z9"}
my-app/
  README.md
  node_modules/
  package.json
...
```js {"id":"01J4Q66FSKZ7FR8FFYRWYM6WYF"}
...
```json {"id":"01J4Q66FSKZ7FR8FFYRYXJ7HP6"}
...
```sh {"id":"01J4Q66FSKZ7FR8FFYS2130WZ1"}
...
```json {"id":"01J4Q66FSKZ7FR8FFYS2AGFF33"}
{
  "version": "0.2.0",
  "configurations": [{
    "name": "Chrome",
...
```sh {"id":"01J4Q66FSKZ7FR8FFYS3NA18TE"}
...
```js {"id":"01J4Q66FSKZ7FR8FFYS62HTA98"}
...
```js {"id":"01J4Q66FSKZ7FR8FFYS7YPX6KK"}
import React, { Component } from 'react';
...
```css {"id":"01J4Q66FSM1S3Y9J8P1GQJXTN4"}
.Button {
  padding: 20px;
}
```
...
```js {"id":"01J4Q66FSM1S3Y9J8P1J3N350B"}
import React, { Component } from 'react';
...
```css {"id":"01J4Q66FSM1S3Y9J8P1J60V8VV"}
.App {
  display: flex;
  flex-direction: row;
  align-items: center;
...
```css {"id":"01J4Q66FSM1S3Y9J8P1K0B808E"}
.App {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
```sh {"id":"01J4Q66FSM1S3Y9J8P1MDJHJ8A"}
npm install node-sass --save-dev
```

Then in `package.json`, add the following lines to `scripts`:

```diff {"id":"01J4Q66FSM1S3Y9J8P1NH7X4CG"}
   "scripts": {
...
```sh {"id":"01J4Q66FSM1S3Y9J8P1QQEZB51"}
npm install --save-dev npm-run-all
```

Then we can change `start` and `build` scripts to include the CSS preprocessor commands:

```diff {"id":"01J4Q66FSM1S3Y9J8P1SZGFXP4"}
   "scripts": {
     "build-css": "node-sass src/ -o src/",
     "watch-css": "npm run build-css && node-sass src/ -o src/ --watch --recursive",
-    "start": "react-scripts start",
...
```js {"id":"01J4Q66FSM1S3Y9J8P1XB338C5"}
...
```css {"id":"01J4Q66FSN76F1P338DRHGZ4Y1"}
.Logo {
...
If you put a file into the `public` folder, it will __not__ be processed by Webpack. Instead it will be copied into the build folder untouched.   To reference assets in the `public` folder, you need to use a special variable called `PUBLIC_URL`.

Inside `index.html`, you can use it like this:

```html {"id":"01J4Q66FSN76F1P338DTM65MC7"}
...
```js {"id":"01J4Q66FSN76F1P338DWX1XB7K"}
render() {
...
```js {"id":"01J4Q66FSPDPE4QHRAD9DX1AQH"}
const $ = window.$;
```
...
```sh {"id":"01J4Q66FSPDPE4QHRADBKRCE6C"}
...
```js {"id":"01J4Q66FSPDPE4QHRADF7P0ZF3"}
...
```js {"id":"01J4Q66FSPDPE4QHRADJ7S7PCV"}
...
There is also a special built-in environment variable called `NODE_ENV`. You can read it from `process.env.NODE_ENV`. When you run `npm start`, it is always equal to `'development'`, when you run `npm test` it is always equal to `'test'`, and when you run `npm run build` to make a production bundle, it is always equal to `'production'`. __You cannot override `NODE_ENV` manually.__ This prevents developers from accidentally deploying a slow development build to production.
...
```jsx {"id":"01J4Q66FSQQBVX306F9X2SX3J0"}
render() {
  return (
    <div>
...
```html {"id":"01J4Q66FSQQBVX306F9YA1Y6WT"}
<div>
...
```js {"id":"01J4Q66FSQQBVX306FA0N5HMDV"}
...
```html {"id":"01J4Q66FSQQBVX306FA19E1SGW"}
...
```cmd {"id":"01J4Q66FSQQBVX306FA2BND6NW"}
...
```bash {"id":"01J4Q66FSRBR4JV1RCBMZR3B78"}
...
```sh {"id":"01J4Q66FSRBR4JV1RCBQ3CC67B"}
...
```sh {"id":"01J4Q66FSRBR4JV1RCBS16TVTE"}
...
```js {"id":"01J4Q66FSRBR4JV1RCBT2YB1YY"}
...
```ini {"id":"01J4Q66FSRBR4JV1RCBWDPNY65"}
...
```cmd {"id":"01J4Q66FSS8FPVW4HS23A32FSP"}
...
```bash {"id":"01J4Q66FSS8FPVW4HS269A2HSE"}
...
```html {"id":"01J4Q66FSS8FPVW4HS28JR1C08"}
<!doctype html>
<html lang="en">
  <head>
...
```js {"id":"01J4Q66FSS8FPVW4HS298YGPA0"}
<!doctype html>
<html lang="en">
  <head>
    <script>
...
Then, on the server, you can replace `__SERVER_DATA__` with a JSON of real data right before sending the response. The client code can then read `window.SERVER_DATA` to use it. __Make sure to [sanitize the JSON before sending it to the client](https://medium.com/node-security/the-most-common-xss-vulnerability-in-react-js-applications-2bdffbcc1fa0) as it makes your app vulnerable to XSS attacks.__
...
```js {"id":"01J4Q66FSTYESQZA4P3YTH0XBZ"}
import sum from './sum';
...
```js {"id":"01J4Q66FSTYESQZA4P40VEGDMT"}
import React from 'react';
...
```sh {"id":"01J4Q66FSTYESQZA4P40Y2Q143"}
npm install --save-dev enzyme react-addons-test-utils
```

```js {"id":"01J4Q66FSTYESQZA4P43M83059"}
import React from 'react';
...
```js {"id":"01J4Q66FSTYESQZA4P47A92AQR"}
import React from 'react';
import { shallow } from 'enzyme';
import App from './App';
...
```js {"id":"01J4Q66FSTYESQZA4P48BZT7B2"}
...
```sh {"id":"01J4Q66FSTYESQZA4P48C0A13V"}
npm install --save-dev jest-enzyme
```

```js {"id":"01J4Q66FSTYESQZA4P49HQ1Q38"}
// src/setupTests.js
import 'jest-enzyme';
```
...
```js {"id":"01J4Q66FSTYESQZA4P4AZQZY23"}
...
```js {"id":"01J4Q66FSTYESQZA4P4E4ZYD76"}
...
```yaml {"id":"01J4Q66FSVAEXHTY1F4X2ARYST"}
language: node_js
node_js:
  - 4
  - 6
...
```cmd {"id":"01J4Q66FSVAEXHTY1F4Z3CP825"}
set CI=true&&npm test
```

```cmd {"id":"01J4Q66FSVAEXHTY1F51KEBN7T"}
...
```bash {"id":"01J4Q66FSVAEXHTY1F551897BP"}
CI=true npm test
```

```bash {"id":"01J4Q66FSVAEXHTY1F583RC2Z5"}
...
```js {"id":"01J4Q66FSVAEXHTY1F5BVXPDEZ"}
  // ...
  "scripts": {
    // ...
    "test": "react-scripts test --env=jsdom"
...
```sh {"id":"01J4Q66FSWRMYVP13CW97ZW9MW"}
npm install -g getstorybook
```

Then, run the following command inside your app’s directory:

```sh {"id":"01J4Q66FSWRMYVP13CWAXT82FA"}
getstorybook
```
...
```sh {"id":"01J4Q66FSWRMYVP13CWEDK5ZYF"}
npm install -g serve
serve -s build
```
...
```sh {"id":"01J4Q66FSWRMYVP13CWH91EKRC"}
serve -h
```
...
```javascript {"id":"01J4Q66FSWRMYVP13CWN1E2Z3T"}
...
```diff {"id":"01J4Q66FSXQZCJCZTQM3M8S4W3"}
 app.use(express.static('./build'));
...
```rb {"id":"01J4Q66FSXQZCJCZTQM5AV759Y"}
    Options -MultiViews
    RewriteEngine On
...
```js {"id":"01J4Q66FSXQZCJCZTQM8PMN6AZ"}
...
```js {"id":"01J4Q66FSXQZCJCZTQM99SEMT0"}
  "homepage": ".",
```
...
```sh {"id":"01J4Q66FSXQZCJCZTQMCVHF7YZ"}
    === Project Setup
...
```sh {"id":"01J4Q66FSXQZCJCZTQMED1S30H"}
...
```js {"id":"01J4Q66FSXQZCJCZTQMED70JCW"}
...
```sh {"id":"01J4Q66FSYCP8J8MHTTMFHZ9H0"}
npm install --save-dev gh-pages
```

Add the following scripts in your `package.json`:

```js {"id":"01J4Q66FSYCP8J8MHTTQDA35WB"}
  // ...
  "scripts": {
    // ...
...
```sh {"id":"01J4Q66FSYCP8J8MHTTRG2S1W1"}
npm run deploy
```
...
```yaml {"id":"01J4Q66FSYCP8J8MHTTS7YZC7Z"}
...
```yaml {"id":"01J4Q66FSYCP8J8MHTTT7BFHQV"}
...
```sh {"id":"01J4Q66FSYCP8J8MHTTV8G6D0P"}
...
```sh {"id":"01J4Q66FSZ1B34Y7907H3ZZE28"}
/*  /index.html  200
```
...
```sh {"id":"01J4Q66FSZ1B34Y7907KB13EVA"}
"now-start": "serve build/",
```

4. Run `now` from your project directory. You will see a **now.sh** URL in your output like this:

```md {"id":"01J4Q66FSZ1B34Y7907KBEJYJW"}
...
```sh {"id":"01J4Q66FSZ1B34Y7907NE5Z88W"}
...
```sh {"id":"01J4Q66FT01FJASMN7YSPZ8DVH"}
